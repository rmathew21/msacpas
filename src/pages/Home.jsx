          ...
          <div className="bg-royal-900 text-white p-10">
            ...
            <div className="flex flex-col gap-6 text-sm">
              ...
              <div className="flex gap-4 items-center">
                ...
                <a href="tel:2815649500" className="text-gray-300 hover:text-royal-300 transition-colors">(281) 564-9500</a>
              </div>
              <div className="flex gap-4 items-center">
                <div className="text-royal-400">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="mailto:samuel@msacpas.com" className="text-gray-300 hover:text-royal-300 transition-colors">samuel@msacpas.com</a>
              </div>
            </div>
          </div>
        </div>
